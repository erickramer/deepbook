...
class TestPrompts(unittest.TestCase):
    ...
    def test_template_format(self):
        ...
        # Format the template
        formatted = TEMPLATE.format(story=story_json, name=name, instructions=instructions)
    ...
    def test_text_template_format(self):
        ...
        # Format the template
        formatted = TEXT_TEMPLATE.format(story=story_json, name=name, instructions=instructions)
    ...
    def test_img_template_format(self):
        ...
        # Format the template
        formatted = IMG_TEMPLATE.format(story=story_json, i=i, character=character)
