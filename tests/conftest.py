...
from app.models import (
    Story, MetaDataModel, CharacterModel, CharactersModel,
    ChapterOutlineModel, BookOutlineModel, ChapterTextModel, FullTextModel
)
...
def sample_story():
    ...
    # Add text
    story.text = FullTextModel(chapters=[
        ChapterTextModel(
            chapter=1,
