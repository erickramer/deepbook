...
from app.models import (
    Model, MetaDataModel, CharacterModel, CharactersModel,
    ChapterOutlineModel, BookOutlineModel, ChapterTextModel,
    FullTextModel, Story, generate_image
)
...
class TestModels(unittest.TestCase):
    ...
    def test_character_model(self):
        ...
        self.assertEqual(model.personality, "Timmy is brave but cautious, always helping others despite his fears.")
    ...
    def test_book_outline_model(self):
        ...
        self.assertEqual(model.synopsis, "A story about a brave turtle helping his forest friends during a storm.")
...
class TestImageGeneration(unittest.TestCase):
    ...
    def test_generate_image(self, mock_prompt_template):
        ...
        story = Story(prompt="A story about a brave turtle")
        story.characters = CharactersModel(characters=[
            CharacterModel(
                name="Timmy",
                description="A small green turtle with a bright yellow shell",
                personality="Timmy is brave but cautious, always helping others despite his fears."
